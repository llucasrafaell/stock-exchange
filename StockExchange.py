...
lbDolar= Label(janela, text=cotacaoDolar, bg='lightgreen', fg = "black", font = "Helvetica 12 bold", width=20, height=1)
...
lbEuro = Label(janela, text=cotacaoEuro, bg='orange', fg="black", font="Helvetica 13 bold", width=18, height=1)
...
lbBitcoin = Label(janela, text=cotacaoBitcoin, bg='purple', fg="black", font="Helvetica 13 bold", width=18, height=1)
